...
class CustomModelViewSet(ModelViewSet,ImportSerializerMixin,ExportSerializerMixin,QueryArgumentsMixin):
    ...
    def update(self, request, *args, **kwargs):
        ...
        return DetailResponse(data=serializer.data, msg="Mis à jour avec succès")

    def destroy(self, request, *args, **kwargs):
        instance = self.get_object()
        instance.delete()
        return DetailResponse(data=[], msg="Supprimé avec succès")


    keys = openapi.Schema(description='Liste des clés primaires', type=openapi.TYPE_ARRAY, items=openapi.TYPE_STRING)
    @swagger_auto_schema(request_body=openapi.Schema(
        type=openapi.TYPE_OBJECT,
        required=['keys'],
        properties={'keys': keys}
    ), operation_summary='Suppression groupée')
    ...
    def multiple_delete(self, request, *args, **kwargs):
        ...
        if keys:
            ...
            return SuccessResponse(data=[], msg="Supprimé avec succès")
        else:
            return ErrorResponse(msg="Champ keys introuvable")
