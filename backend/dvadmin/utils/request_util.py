...
def get_request_user(request):
    ...
    (1) si l'utilisateur dans request n'est pas authentifié, l'authentifier manuellement une fois
    :param request:
    :return:
    """
...
def get_ip_analysis(ip):
    """
    Récupérer le résumé détaillé de l'IP
    :param ip: adresse IP
    :return:
    """
    data = {
